  ...
  return (
    <nav className="navbar">
      ...
      <span className="nav-item">
        <img src="/assets/loc1.jpeg" alt="Location Icon" className="location-icon" />
        ...
        <span className="nav-item">
            <a href="tel:+919653392272" className="nav-link">
                <img src="/assets/call.jpeg" alt="Phone Icon" className='location-icon'/> 
                9653392272
            </a>
        </span>
      ...
      <img src="/assets/di.jpeg" alt="Company Icon" className='location-icon'/> 
        <Link to="/" className="navbar-logo">Dental Hi-Fi</Link>
      </div>
